...
== hexl-viper-mode-patch.el

Patch for using both hexl-mode and viper-mode.

=== Usage

  (require 'hexl-viper-mode-patch)

== immortal-buffer.el

Make buffer immortal. Immortal buffer will be just cleared when you
kill the buffer. And it will be respawned when you save the buffer.
...
Provide feature of default command from the top of the history in
