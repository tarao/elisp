...
;; Author: INA Lintaro <tarao.gnn@gmail.com>
...
;; It provides a mechanism to bind both prefix and non-prefix keys to commands.

;;; Usage:

;;   (require 'key-intercept)
;;   (define-key some-key-map (kbd "C-c C-j") 'a-command)
;;   (define-intercept-key (kbd "C-c") 'another-command)
